...
export function Hiring() {
  ...
  return (
    <p className="text-base sm:text-lg text-neutral-600 dark:text-neutral-400 mb-6 max-w-2xl leading-relaxed">
      We are{" "}
      <Link
        to="/#join-us"
...
export function JoinUs() {
  return (
    <div className="flex flex-col items-start w-full">
      <h2 className="text-2xl sm:text-3xl font-semibold text-neutral-900 dark:text-neutral-100 mb-4">Join Us</h2>
      <p className="text-base sm:text-lg text-neutral-600 dark:text-neutral-400 mb-6 max-w-2xl leading-relaxed">
