    ...
    <div className="grow w-full md:max-w-3xl research">
      ...
      <section>
        ...
        <p className="text-lg text-gray-700 leading-relaxed">
          We present a method for building <em>proactive agents</em> that work
          continuously over time, schedule their own activities, and create
          workflows dynamically. Unlike traditional agents that only respond to
          user input, proactive agents actively pursue goals without constant
          prompting. We describe how we evolved the agent from simple,
          predefined workflows to a fully autonomous system that manages its own
          sleep cycles and maintains ledger-like decaying memory. This
          architecture provides a clear path toward agents that take initiative
          and maintain long-term responsibility for given objectives.
        </p>
      </section>
      ...
      <section>
        ...
        <div className="prose prose-lg text-gray-700 leading-relaxed space-y-4">
          ...
          <p>
            ...
            schedules its own activities, reason about time, and creates dynamic
...
def run_every_hour(...) # runs 0 * * * *
    for user in db.get_users():
        run_agent(user)`}</code>
          ...
          <p>
            While this approach shows how dynamic workflows are required, there
            agent is still static across time.
          </p>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="prose prose-lg text-gray-700 leading-relaxed space-y-4">
          ...
          <p>
            With this approach, a simple cron jobs can be used to wake up agents
            whose sleep time has expired—similar to how operating systems handle
            timer interrupts. This approach reduces allows the agent to allocate
            compute resources dynamically over time.
          </p>
          <p>
    ...
    wake_agent(user)`}</code>
      ...
      <section>
        ...
        <div className="prose prose-lg text-gray-700 leading-relaxed space-y-4">
          ...
          <div className="mt-6">
            <h3 className="text-xl font-medium text-gray-900 mb-3">
              4.4 Ledger-Based Memory Architecture
            </h3>
            <p>
    ...
    "properties": {
      "limit": {
        ...
        "description": "Limits emails checked."
          ...
          <p>
            The second schema uses language patterns that align closely to human
            natural language—making it more likely the model "knows how" to use
            the tool out of the box, because similar phrasing appears frequently
            in model training. The first, on the other hand, is specific to a
            particular system and incurs extra interpretive effort for the
            model.
          </p>
          <p>
          ...
          <p>
            When tool interfaces reflect the types of actions and naming
            patterns present in language model pretraining data—so called{" "}
            <strong>in-sample framing</strong>—the agent spends less cognitive
            effort inferring intent or proper usage. This directly increases
            reliability and task efficiency by letting the agent focus on
